  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block text-sm font-black">{shoppingDayLabel}曜の買い物</span>
        <span className="mt-0.5 block text-xs font-bold text-kondate-muted">今週のリスト {itemCount}品</span>
      </span>
