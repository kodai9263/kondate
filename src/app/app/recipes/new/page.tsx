...
function Field({ label, name, required = false, helper }: { label: string; name: string; required?: boolean; helper?: string }) { return <label className="block text-sm font-semibold">{label} {required ? <Required /> : null}<input name={name} required={required} className="mt-2 min-h-12 w-full rounded-lg border border-kondate-line bg-white px-3.5 text-base font-normal outline-none transition-colors focus:border-kondate-accent focus:ring-2 focus:ring-kondate-accent/15" />{helper ? <span className="mt-1 block text-xs font-normal leading-6 text-kondate-faint">{helper}</span> : null}</label>; }
function TextArea({ label, name, helper }: { label: string; name: string; helper?: string }) { return <label className="block text-sm font-semibold">{label} <Required /><textarea name={name} required rows={5} className="mt-2 w-full rounded-lg border border-kondate-line bg-white p-3.5 text-base font-normal outline-none transition-colors focus:border-kondate-accent focus:ring-2 focus:ring-kondate-accent/15" />{helper ? <span className="mt-1 block text-xs font-normal leading-6 text-kondate-faint">{helper}</span> : null}</label>; }
